...
Options:
    ...
    /compiletypes                             Pre-compile any typed classes into CLR types. This requires importing all files specified on the command line.
...
def Main(args):
    ...
    print "Compiling..."
    clr.CompileModules(config.output + ".dll", mainModule = config.main_name, compileTypes = config.compile_types, *config.files)
